...
public class WebSocketAuthInterceptor implements HandshakeInterceptor {
	...
	public boolean beforeHandshake(@NonNull ServerHttpRequest request, @NonNull ServerHttpResponse response,
		...
		log.info("[{}] WebSocket handshake attempt from: {}", correlationId, request.getRemoteAddress());
		...
		try {
			...
			log.info("[{}] WebSocket handshake successful for user: {}, sessionId: {}", correlationId, userId, sessionId);
			return true;
