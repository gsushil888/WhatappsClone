...
public class MessageController {
	...
	public ResponseEntity<ApiResponse<MessageDto.MessageListResponse>> getMessages(Authentication authentication,
			@PathVariable Long conversationId, @RequestParam(defaultValue = "50") int limit,
			@RequestParam(required = false) Long beforeMessageId, @RequestParam(required = false) Long afterMessageId,
