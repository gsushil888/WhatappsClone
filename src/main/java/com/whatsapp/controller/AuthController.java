...
public class AuthController {
  ...
  public ResponseEntity<ApiResponse<AuthDto.LoginResponse>> login(
    ...
    return ResponseEntity.ok(ApiResponse.<AuthDto.LoginResponse>builder().success(true)
        .message(message).data(response).correlationId(RequestContext.getCorrelationId()).build());
  }
  ...
  public ResponseEntity<ApiResponse<AuthDto.RefreshTokenResponse>> refreshToken(
    ...
    return ResponseEntity.ok(ApiResponse.<AuthDto.RefreshTokenResponse>builder().success(true)
        .data(response).correlationId(RequestContext.getCorrelationId()).build());
  }
  ...
  public ResponseEntity<ApiResponse<Void>> logout(Authentication authentication,
    ...
    AuthDto.LogoutRequest logoutRequest =
        request != null ? request : AuthDto.LogoutRequest.builder().logoutAllDevices(false).build();
    ...
    return ResponseEntity
        .ok(ApiResponse.<Void>builder().success(true).message("Logged out successfully")
            .correlationId(RequestContext.getCorrelationId()).build());
  }
  ...
  public ResponseEntity<ApiResponse<AuthDto.RegisterResponse>> resendOtp(
    ...
    return ResponseEntity.ok(ApiResponse.<AuthDto.RegisterResponse>builder().success(true)
        .message("OTP resent successfully").data(response)
        .correlationId(RequestContext.getCorrelationId()).build());
  }
  ...
  public ResponseEntity<ApiResponse<AuthDto.SessionValidationResponse>> validateSession(
    ...
    if (authentication == null || authentication.getPrincipal() == null) {
      ...
      AuthDto.SessionValidationResponse response = AuthDto.SessionValidationResponse.builder()
          .valid(false).message("Not authenticated").build();

      return ResponseEntity.ok(ApiResponse.<AuthDto.SessionValidationResponse>builder()
          .success(false).message("Authentication required").data(response)
          .correlationId(RequestContext.getCorrelationId()).build());
    }
    ...
    return ResponseEntity.ok(ApiResponse.<AuthDto.SessionValidationResponse>builder().success(true)
        .message("Session validated").data(response)
        .correlationId(RequestContext.getCorrelationId()).build());
  }
}
...
// @RequestParam(value = "profilePicture", required = false) MultipartFile profilePicture) {
//
// log.info("[CONTROLLER] POST /api/v1/auth/register - email: {}, correlationId: {}",
// request.getEmail(),
// RequestContext.getCorrelationId());
//
// AuthDto.RegisterResponse response = authService.register(request, profilePicture);
//
// log.info("[CONTROLLER] Registration successful - username: {}, correlationId: {}",
...
//
// @PostMapping("/login")
// public ResponseEntity<ApiResponse<AuthDto.LoginResponse>> login(@Valid @RequestBody
// AuthDto.LoginRequest request) {
//
// log.info("[CONTROLLER] POST /api/v1/auth/login - identifierType: {}, deviceFingerprint: {},
// correlationId: {}",
// request.getIdentifierType(), RequestContext.getDeviceFingerprint(),
// RequestContext.getCorrelationId());
//
...
// ? (response.getMessage() != null && response.getMessage().contains("already sent") ? "OTP already
// sent"
// : "Verification required")
// : (response.getUser() != null && response.getSession() != null ? "Already logged in. Session
// refreshed"
// : "Login successful");
//
...
//
// return
// ResponseEntity.ok(ApiResponse.<AuthDto.LoginResponse>builder().success(true).message(message)
// .data(response).correlationId(RequestContext.getCorrelationId()).build());
// }
//
// @PostMapping("/verify-otp")
...
//
// return
// ResponseEntity.ok(ApiResponse.<AuthDto.LoginResponse>builder().success(true).data(response)
// .correlationId(RequestContext.getCorrelationId()).build());
// }
//
// @PostMapping("/refresh")
...
// @Valid @RequestBody AuthDto.RefreshTokenRequest request) {
//
// log.info("[CONTROLLER] POST /api/v1/auth/refresh - correlationId: {}",
// RequestContext.getCorrelationId());
//
// AuthDto.RefreshTokenResponse response = authService.refreshToken(request);
//
// log.info("[CONTROLLER] Token refreshed successfully - correlationId: {}",
// RequestContext.getCorrelationId());
//
// return
// ResponseEntity.ok(ApiResponse.<AuthDto.RefreshTokenResponse>builder().success(true).data(response)
// .correlationId(RequestContext.getCorrelationId()).build());
// }
//
// @PostMapping("/logout")
...
//
// log.info("[CONTROLLER] POST /api/v1/auth/logout - userId: {}, allDevices: {}, correlationId: {}",
// userId,
...
// RequestContext.getCorrelationId());
//
// return ResponseEntity.ok(ApiResponse.<Void>builder().success(true).message("Logged out
// successfully")
// .correlationId(RequestContext.getCorrelationId()).build());
// }
//
...
// AuthDto.RegisterResponse response = authService.resendOtp(request);
//
// log.info("[CONTROLLER] OTP resent successfully - username: {}, correlationId: {}",
// response.getUsername(),
// RequestContext.getCorrelationId());
//
// return ResponseEntity
// .ok(ApiResponse.<AuthDto.RegisterResponse>builder().success(true).message("OTP resent
// successfully")
// .data(response).correlationId(RequestContext.getCorrelationId()).build());
// }
// }
