...
public class ConversationController {
  ...
  public ResponseEntity<ApiResponse<ConversationDto.ConversationListResponse>> getConversations(
    ...
    ConversationDto.ConversationListResponse conversations =
        conversationService.getUserConversations(userId, limit, offset, filter);

    return ResponseEntity
        .ok(ApiResponse.<ConversationDto.ConversationListResponse>builder().success(true)
  ...
  public ResponseEntity<ApiResponse<ConversationDto.ConversationResponse>> createConversation(
    ...
    Long userId = (Long) authentication.getPrincipal();
    ConversationDto.ConversationResponse conversation =
        conversationService.createConversation(userId, request);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.ConversationResponse>builder()
        .success(true).data(conversation).correlationId(RequestContext.getCorrelationId())
  ...
  public ResponseEntity<ApiResponse<ConversationDto.ConversationDetailsResponse>> getConversationDetails(
    ...
    ConversationDto.ConversationDetailsResponse conversation =
        conversationService.getConversationDetails(userId, conversationId);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.ConversationDetailsResponse>builder()
        .success(true).data(conversation).correlationId(RequestContext.getCorrelationId()).build());
  }
  ...
  public ResponseEntity<ApiResponse<ConversationDto.ConversationResponse>> updateConversation(
    ...
    ConversationDto.ConversationResponse response =
        conversationService.updateConversation(userId, conversationId, request);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.ConversationResponse>builder()
        .success(true).data(response).correlationId(RequestContext.getCorrelationId())
  ...
  public ResponseEntity<ApiResponse<ConversationDto.ConversationSettingsResponse>> updateConversationSettings(
    ...
    Long userId = (Long) authentication.getPrincipal();
    ConversationDto.ConversationSettingsResponse response =
        conversationService.updateConversationSettings(userId, conversationId, request);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.ConversationSettingsResponse>builder()
        .success(true).data(response).correlationId(RequestContext.getCorrelationId())
  ...
  public ResponseEntity<ApiResponse<ConversationDto.AddParticipantsResponse>> addParticipants(
    ...
    Long userId = (Long) authentication.getPrincipal();
    ConversationDto.AddParticipantsResponse response =
        conversationService.addParticipants(userId, conversationId, request);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.AddParticipantsResponse>builder()
        .success(true).data(response).correlationId(RequestContext.getCorrelationId())
  ...
  public ResponseEntity<ApiResponse<ConversationDto.MuteConversationResponse>> muteConversation(
    ...
    Long userId = (Long) authentication.getPrincipal();
    ConversationDto.MuteConversationResponse response =
        conversationService.muteConversation(userId, conversationId, request);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.MuteConversationResponse>builder()
        .success(true).data(response).correlationId(RequestContext.getCorrelationId())
  ...
  public ResponseEntity<ApiResponse<ConversationDto.DeleteConversationResponse>> deleteConversation(
    ...
    Long userId = (Long) authentication.getPrincipal();
    ConversationDto.DeleteConversationResponse response =
        conversationService.deleteConversation(userId, conversationId);

    return ResponseEntity.ok(ApiResponse.<ConversationDto.DeleteConversationResponse>builder()
        .success(true).data(response).correlationId(RequestContext.getCorrelationId())
