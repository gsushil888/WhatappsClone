...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserDto.UserProfileResponse>> getCurrentUser(
        ...
        return ResponseEntity.ok(ApiResponse.<UserDto.UserProfileResponse>builder()
                .success(true)
                .data(user)
    ...
    public ResponseEntity<ApiResponse<SearchDto.UniversalSearchResponse>> universalSearch(
        ...
        return ResponseEntity.ok(ApiResponse.<SearchDto.UniversalSearchResponse>builder()
                .success(true)
                .data(response)
                .correlationId(RequestContext.getCorrelationId())
                .build());
    ...
    public ResponseEntity<ApiResponse<List<UserDto.SessionResponse>>> getUserSessions(
        ...
        return ResponseEntity.ok(ApiResponse.<List<UserDto.SessionResponse>>builder()
                .success(true)
                .data(sessions)
                .correlationId(RequestContext.getCorrelationId())
                .build());
