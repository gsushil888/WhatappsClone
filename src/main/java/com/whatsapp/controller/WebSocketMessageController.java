...
public class WebSocketMessageController {
  ...
  public void sendMessage(@Payload MessageDto.SendMessageRequest request,
    ...
    try {
      ...
      MessageDto.MessageResponse response =
          messageService.sendMessage(userId, conversationId, request, null, null);
  ...
  public void handleWebRTCSignal(@Payload WebRTCSignal signal, Principal principal) {
    try {
      ...
      messagingTemplate.convertAndSendToUser(signal.getTargetUserId().toString(), "/queue/calls",
          signal);
  ...
  public static class StoryView {
    ...
    public Long getStoryOwnerId() {
      return storyOwnerId;
    }

    public void setStoryOwnerId(Long storyOwnerId) {
