...
public class CallController {
	...
	public ResponseEntity<ApiResponse<CallDto.CallResponse>> initiateCall(
		...
		return ResponseEntity.ok(ApiResponse.<CallDto.CallResponse>builder()
				.success(true).data(call)
				.correlationId(RequestContext.getCorrelationId())
				.message("Call initiated successfully").build());
	}

	@PostMapping("/{callId}/answer")
	public ResponseEntity<ApiResponse<CallDto.CallResponse>> answerCall(
			Authentication authentication, @PathVariable Long callId,
			@Valid @RequestBody CallDto.AnswerCallRequest request) {

		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallResponse call = callService.answerCall(userId, callId,
				request);

		return ResponseEntity.ok(ApiResponse.<CallDto.CallResponse>builder()
				.success(true).data(call)
				.correlationId(RequestContext.getCorrelationId())
				.message("Call answered successfully").build());
	}
	...
	public ResponseEntity<ApiResponse<CallDto.CallResponse>> declineCall(
		...
		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallResponse call = callService.declineCall(userId, callId,
				request);

		return ResponseEntity.ok(ApiResponse.<CallDto.CallResponse>builder()
				.success(true).data(call)
				.correlationId(RequestContext.getCorrelationId())
				.message("Call declined successfully").build());
	}

	@PostMapping("/{callId}/end")
	public ResponseEntity<ApiResponse<CallDto.CallResponse>> endCall(
			Authentication authentication, @PathVariable Long callId) {
		...
		return ResponseEntity.ok(ApiResponse.<CallDto.CallResponse>builder()
				.success(true).data(call)
				.correlationId(RequestContext.getCorrelationId())
				.message("Call ended successfully").build());
	}

	@PostMapping("/{callId}/join")
	public ResponseEntity<ApiResponse<CallDto.CallResponse>> joinCall(
			Authentication authentication, @PathVariable Long callId,
			@Valid @RequestBody CallDto.JoinCallRequest request) {

		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallResponse call = callService.joinCall(userId, callId,
				request);

		return ResponseEntity.ok(ApiResponse.<CallDto.CallResponse>builder()
				.success(true).data(call)
				.correlationId(RequestContext.getCorrelationId())
				.message("Joined call successfully").build());
	}

	@PostMapping("/{callId}/leave")
	public ResponseEntity<ApiResponse<CallDto.CallResponse>> leaveCall(
			Authentication authentication, @PathVariable Long callId) {
		...
		return ResponseEntity.ok(ApiResponse.<CallDto.CallResponse>builder()
				.success(true).data(call)
				.correlationId(RequestContext.getCorrelationId())
				.message("Left call successfully").build());
	}
	...
	public ResponseEntity<ApiResponse<CallDto.CallParticipantResponse>> toggleMute(
		...
		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallParticipantResponse participant = callService
				.toggleMute(userId, callId, request.getIsMuted());

		return ResponseEntity
				.ok(ApiResponse.<CallDto.CallParticipantResponse>builder()
	...
	public ResponseEntity<ApiResponse<CallDto.CallParticipantResponse>> toggleVideo(
		...
		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallParticipantResponse participant = callService
				.toggleVideo(userId, callId, request.getIsVideoEnabled());
	...
	public ResponseEntity<ApiResponse<CallDto.CallHistoryResponse>> getCallHistory(
		...
		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallHistoryResponse history = callService.getCallHistory(userId,
				limit, offset, type, status);

		return ResponseEntity
				.ok(ApiResponse.<CallDto.CallHistoryResponse>builder()
	...
	public ResponseEntity<ApiResponse<CallDto.CallStatisticsResponse>> getCallStatistics(
		...
		Long userId = (Long) authentication.getPrincipal();
		CallDto.CallStatisticsResponse statistics = callService
				.getCallStatistics(userId, period);

		return ResponseEntity
				.ok(ApiResponse.<CallDto.CallStatisticsResponse>builder()
