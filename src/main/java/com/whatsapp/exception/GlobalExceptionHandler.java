...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAuthException(AuthException ex, WebRequest request) {
        String correlationId = RequestContext.getCorrelationId();
        log.error("Authentication error [{}]: {} - {}", correlationId, ex.getErrorCode().getCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleUserException(UserException ex, WebRequest request) {
        String correlationId = RequestContext.getCorrelationId();
        log.error("User error [{}]: {} - {}", correlationId, ex.getErrorCode().getCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleConversationException(ConversationException ex, WebRequest request) {
        String correlationId = RequestContext.getCorrelationId();
        log.error("Conversation error [{}]: {} - {}", correlationId, ex.getErrorCode().getCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleMessageException(MessageException ex, WebRequest request) {
        String correlationId = RequestContext.getCorrelationId();
        log.error("Message error [{}]: {} - {}", correlationId, ex.getErrorCode().getCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleSystemException(SystemException ex, WebRequest request) {
        String correlationId = RequestContext.getCorrelationId();
        log.error("System error [{}]: {} - {}", correlationId, ex.getErrorCode().getCode(), ex.getMessage(), ex);
