...
@Table(name = "system_errors",
    indexes = {@Index(name = "idx_error_correlation", columnList = "correlationId"),
...
public class SystemError {
  ...
  public enum ErrorCategory {
    AUTHENTICATION, AUTHORIZATION, VALIDATION, DATABASE, NETWORK, FILE_UPLOAD, WEBSOCKET, EXTERNAL_API, BUSINESS_LOGIC, SYSTEM, UNKNOWN
  }
}
