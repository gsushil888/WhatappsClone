...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(@NonNull HttpServletRequest request,
    ...
    log.info("[JWT-FILTER] {} {} - Auth header present: {}", method, requestUri,
        authHeader != null);
      ...
      try {
        ...
        if (jwtUtil.validateToken(token)) {
          ...
          if (isSessionActive) {
            ...
            log.info(
                "[JWT-FILTER] Authentication successful - userId: {}, sessionId: {}, path: {} {}",
                userId, sessionId, method, requestUri);
          } else {
            log.warn("[JWT-FILTER] Session {} inactive for userId: {}, path: {} {}", sessionId,
        ...
        log.error("[JWT-FILTER] Authentication failed for {} {}: {}", method, requestUri,
            ex.getMessage());
      }
    } else {
