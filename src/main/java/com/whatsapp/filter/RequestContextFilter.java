...
public class RequestContextFilter extends OncePerRequestFilter {
  ...
  private static final String[] DEVICE_HEADERS = {"X-Device-Type", "X-Device-OS",
      "X-Device-OS-Version", "X-App-Version", "X-Device-Model", "X-Device-Fingerprint"};

  private static final String[] TRACKED_HEADERS =
      {"Authorization", "User-Agent", "X-Forwarded-For", "X-Real-IP", "X-Device-Fingerprint"};
  ...
  protected void doFilterInternal(@NonNull HttpServletRequest request,
    ...
    RequestContext.RequestInfo requestInfo = RequestContext.RequestInfo.builder()
        ...
        .userAgent(request.getHeader("User-Agent")).startTime(System.currentTimeMillis()).build();
    ...
    try {
      ...
      log.error("[REQUEST-ERROR] {} {} - Duration: {}ms, correlationId: {}, Error: {}", method,
          requestUri, duration, correlationId, e.getMessage(), e);
      throw e;
    } finally {
